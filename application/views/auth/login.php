                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('auth/index'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="password" mame="password" placeholder="Password"><?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
