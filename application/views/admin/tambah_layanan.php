...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <?php echo form_open_multipart('Admin/Layanan/tambahLayanan'); ?>
            ...
            <input type="file" name="gambar_layanan" class="form-control" value="<?= set_value('durasi_layanan'); ?>"><?= form_error('durasi_layanan', '<small class="text-danger pl-3">', '</small>'); ?><br>
